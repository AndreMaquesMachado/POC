...
public class mainJavafx  {
    ...
    public void main(String[] args) throws SQLException, ClassNotFoundException, JSONException, InterruptedException, ParseException, IOException {
            inicio1();
    }
    ...
    public  void inicio1() throws SQLException, ParseException, JSONException, IOException, ClassNotFoundException, InterruptedException {
        ...
        String sqlinjection = (String)jtm.queryForObject(sql, new Object[]{"1' or '1' ='1"}, String.class);
